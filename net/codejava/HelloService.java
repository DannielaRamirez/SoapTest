 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://codejava.net/", wsdlLocation = "http://localhost:8080/SoapTest/hellows?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/SoapTest/hellows?wsdl");
