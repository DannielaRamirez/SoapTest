 ...
 * 
 */
@WebServiceClient(name = "ProductService", targetNamespace = "http://codejava.net/", wsdlLocation = "http://localhost:8080/SoapTest/ws/product?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICE_QNAME = new QName("http://codejava.net/", "ProductService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SoapTest/ws/product?wsdl");
    ...
    public Product getProductPort() {
        return super.getPort(new QName("http://codejava.net/", "ProductPort"), Product.class);
    }
    ...
    public Product getProductPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://codejava.net/", "ProductPort"), Product.class, features);
    }
