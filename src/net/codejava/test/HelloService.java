 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://codejava.net/", wsdlLocation = "http://localhost:8080/SoapTest/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://codejava.net/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SoapTest/ws/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://codejava.net/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://codejava.net/", "HelloPort"), Hello.class, features);
    }
